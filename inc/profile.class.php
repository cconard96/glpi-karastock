...
class PluginKarastockProfile extends Profile {
    ...
    /**
     * Install or update PluginKarastockProfile
     *
    ...
    /**
     * Uninstall PluginKarastockProfile
     *
     * @return boolean
     */
    public static function uninstall() {
        ...
        $query = "DELETE
                  ...
                  WHERE `name` LIKE 'plugin_karastock_%'";
    ...
    public static function initProfile() {
        ...
        $profiles = $DB->request("SELECT *
            ...
            AND `name` LIKE 'plugin_Karastock_%'");
